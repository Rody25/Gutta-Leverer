...
<body>
    ...
    echo 'const product = [
        ...
        {
            id: 1,
            Image: "bilder/krydret skinke.jpg",
            titile: "KrydretSkinke",
            price: 120,
          },
        
          {
            id: 2,
            Image: "bilder/hamburgerrygg.jpg",
            titile: "Hamburgerrygg",
            price: 120,
          },
        
          {
            id: 3,
            Image: "bilder/salami.jpg",
            titile: "Salami",
            price: 120,
          },
        ...
        return `
            <div class="box">
                ...
                <div class="bottom">
                    <p>${titile}</p>
                    <h2>${price}.00</h2>
                    <button class="bm" onclick="addtocart(${id})">Add to cart</button>
                </div>
            </div>`;
    }).join("");';
