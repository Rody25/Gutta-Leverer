        ...
        <div class="wrapper wrapper-main">
            <div class="varer-r">
                <div class="varerM-container">
                    <img src="bilder/ost.png" alt="" class="r-image">
            ...
            <div class="varer-r">
                <div class="varerM-container">
                    <img src="bilder/smør.png" alt="" class="r-image">
                    <h3 class="text-tag1">Battery</h3>
                    <h3 class="text-tag1">Pris 23,50kr</h3>
                    <a href="..." class="r-link"> Legg til:</a>
                </div>
            ...
            <div class="varer-r">
                <div class="varerM-container">
                    <img src="bilder/yoghurt.jpg" alt="" class="r-image">
                    <h3 class="text-tag1">Battery</h3>
                    <h3 class="text-tag1">Pris 23,50kr</h3>
                    <a href="..." class="r-link"> Legg til:</a>
                </div>
            ...
            <div class="varer-r">
                <div class="varerM-container">
                    <img src="bilder/melange.png" alt="" class="r-image">
                    <h3 class="text-tag1">Battery</h3>
                    <h3 class="text-tag1">Pris 23,50kr</h3>
                    <a href="..." class="r-link"> Legg til:</a>
                </div>
            ...
            <div class="varer-r">
                <div class="varerM-container">
                    <img src="bilder/vegansk.png" alt="" class="r-image">
                    <h3 class="text-tag1">Battery</h3>
                    <h3 class="text-tag1">Pris 23,50kr</h3>
                    <a href="..." class="r-link"> Legg til:</a>
                </div>
